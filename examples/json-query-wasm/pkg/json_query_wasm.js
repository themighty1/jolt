/* @ts-self-types="./json_query_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function prove_json_query(query, json_data) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ptr1 = passStringToWasm0(json_data, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len1 = WASM_VECTOR_LEN;
        wasm.prove_json_query(retptr, ptr0, len0, ptr1, len1);
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('json_query_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
