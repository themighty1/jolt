/* @ts-self-types="./integer_check_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function prove_integer_check(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.prove_integer_check(retptr, ptr0, len0);
...
function __wbg_get_imports(memory) {
    ...
    return {
        __proto__: null,
        "./integer_check_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('integer_check_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
